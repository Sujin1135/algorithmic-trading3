...
public class Test_7 {
    public static void main(String[] args) {
        ...
        person1.addEstate(new House("춘천시 퇴계동 805-304", 200000000, 30, 3));
...
class WealthyPerson implements Wealthy {
    ...
    private int money = 0; // 총 자산
    private int averagePrice = 0; // 평균 자산
    ...
    public WealthyPerson addStock (Stock stock) {
        ...
        averagePrice = money / (stockList.size() + estateList.size());
        return this;
    }
